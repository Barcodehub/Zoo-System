...
public class StatsService {
    ...
    public double calculateAnsweredCommentsPercentage() {
        ...
        return (answeredComments * 100.0) / totalComments;
    }
    ...
    public List<AnimalDetailResponse> getAnimalsByRegistrationDate(LocalDate date) {
        return animalRepository.findByRegistrationDate(date).stream()
